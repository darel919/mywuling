<template>
    <div class="container mx-auto p-4">
        <div v-if="loading && !carData" class="text-center">
            Loading car status...
        </div>
        <div v-else-if="error && !carData" class="text-red-500">
            {{ error }}
        </div>
        <div v-else class="space-y-6">            
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <!-- Car Status -->
                    <div v-if="carData.car.data.car_status" class="card bg-base-100 shadow-xl">
                        <div class="card-body">
